...
\bibitem[Artmann {\em et~al.}(2011)Artmann, Jung, Bleckmann, and
  Beissbarth]{detection_artmann_submitted}
Artmann, S., Jung, K., Bleckmann, A., and Beissbarth, T. (2011).
...
\bibitem[Jung {\em et~al.}(2011)Jung, Becker, Brunner, and
  Beissbarth]{jung_comparison_submitted}
Jung, K., Becker, B., Brunner, E., and Beissbarth, T. (2011).
